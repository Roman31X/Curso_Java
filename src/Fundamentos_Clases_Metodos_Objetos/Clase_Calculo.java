...
public class Clase_Calculo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("La multiplicación de a * b es: "+ Multiplicación(a,b));
    ...
    /**DESCRIPCIÓN
    * La clase Valor nos retorna una cadena de caracteres
    ...
    * carácter*/
    ...
    /**
     * Descripción: esta función realiza la suma de los valores
     * asignados
     * @param a  Valor asignado a
     * @param b  Valor asignado b
     * Finalmente regresa el valor de la suma
     * */
