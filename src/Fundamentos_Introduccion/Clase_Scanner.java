...
public class Clase_Scanner {
    public static void main(String[] args) {
        ...
        //Solicitamos que digiten un dato para la varible nombre
        System.out.println("Ingrese su nombre USUARIO");
        //mediante el objeto "sc" instanciamos el metodo "nextLine()"
        //que nos permite leer los datos en la linea de ejecución
