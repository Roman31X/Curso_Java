...
public class Conversion_PrimitivosJava {
    public static void main(String[] args) {
        ...
        //COMO RECUPERAR UN CARÁCTER DE UNA CADENA
        String nombre = "Diego";
        System.out.println("nombre = " + nombre);

        /*Designamos una variable que almacenara un solo carácter
        * Mediante ".charAt()" podemos obtener un carácter de la cadena
        * de tipo String este necesita la posición del carácter a
