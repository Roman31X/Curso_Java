...
public class Operadore_Aritméticos {
    ...
    * */
    ...
    public static void main(String[] args) {
        ...
        double c=0,d=0,e=0,f=0,g=0; //Variable almacenará el resultado
        ...
        //DIVICIÓN
        f = a / b;
        System.out.println("La división de ["+a+"] / ["+b+"] es : ["+f+"]");

        //RESIDUO
        g = a % b;
        System.out.println("El residuo de la división es : ["+g+"]");
